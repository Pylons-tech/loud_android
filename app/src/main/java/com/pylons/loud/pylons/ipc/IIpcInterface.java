package com.pylons.loud.pylons.ipc;
...
public interface IIpcInterface extends android.os.IInterface {
     ...
     */
    public static class Default implements com.pylons.loud.pylons.ipc.IIpcInterface {
        @Override
     ...
     */
    public static abstract class Stub extends android.os.Binder implements com.pylons.loud.pylons.ipc.IIpcInterface {
         ...
         */
        public static com.pylons.loud.pylons.ipc.IIpcInterface asInterface(android.os.IBinder obj) {
            if ((obj == null)) {
                return null;
            }
            android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (((iin != null) && (iin instanceof com.pylons.loud.pylons.ipc.IIpcInterface))) {
                return ((com.pylons.loud.pylons.ipc.IIpcInterface) iin);
            }
            return new com.pylons.loud.pylons.ipc.IIpcInterface.Stub.Proxy(obj);
        }
        ...
        private static class Proxy implements com.pylons.loud.pylons.ipc.IIpcInterface {
        ...
        public static com.pylons.loud.pylons.ipc.IIpcInterface getDefaultImpl() {
