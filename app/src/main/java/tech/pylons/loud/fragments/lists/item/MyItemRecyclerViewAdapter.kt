package tech.pylons.loud.fragments.lists.item
...
import tech.pylons.loud.fragments.lists.item.ItemFragment.OnListFragmentInteractionListener
    ...
    private fun render(character: Character, holder: InventoryCharacterViewHolder) {
        ...
        with(context) {
            ...
            text.text = when (character.special) {
                tech.pylons.loud.constants.Character.FIRE_SPECIAL -> getString(R.string.fire_icon)
                tech.pylons.loud.constants.Character.ICE_SPECIAL -> getString(R.string.ice_icon)
                tech.pylons.loud.constants.Character.ACID_SPECIAL -> getString(R.string.acid_icon)
            ...
            if (character.specialDragonKill > 0) {
                val icon = when (character.special) {
                    tech.pylons.loud.constants.Character.FIRE_SPECIAL -> getString(R.string.fire_dragon_icon)
                    tech.pylons.loud.constants.Character.ICE_SPECIAL -> getString(R.string.ice_dragon_icon)
                    tech.pylons.loud.constants.Character.ACID_SPECIAL -> getString(R.string.acid_dragon_icon)
                    else -> ""
                }
                val text = TextView(context)
